...
#Third plot
plot(x = datetime, y = workData$Voltage, type = "l", ylab = "Voltage")
#Fourth plot
plot(x = datetime, y = workData$Global_reactive_power, type = "l", ylab = "Global_reactive_power")
dev.off()
